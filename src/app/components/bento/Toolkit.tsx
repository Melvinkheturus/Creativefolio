...
export default function Toolkit() {
  ...
  return (
    <motion.div
      ref={cardRef}
      className="bg-[#0a0912]/60 backdrop-blur-xl border border-white/5 rounded-2xl p-5 shadow-lg overflow-hidden relative h-full"
    ...
    >
      ...
      <h3 className="text-base md:text-lg font-semibold mb-3 md:mb-4 relative z-10">
        <span className="text-white">MY </span>
        <span className="text-purple-400">TOOL KIT</span>
      </h3>
