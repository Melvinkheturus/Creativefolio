    ...
    >
      ...
      <div className="flex items-center relative z-10">
        ...
        <div className="relative">
          ...
          <div className="w-24 h-24 md:w-28 md:h-28 rounded-xl overflow-hidden shadow-lg relative">
            <Image 
              src="/profile-pic.png" 
              alt="Manikandan" 
              width={112}
        ...
        <div className="flex flex-col justify-center ml-5">
          <h2 
            className="text-lg font-semibold tracking-wider cursor-pointer text-white"
          ...
          <div className="mt-1">
            ...
            <p className="font-allura text-base text-purple-300">
